      ...
      <View style={styles.container}>
        <ScrollView>
          <View style={styles.header}>
            <Image
              ...
              source={{
                uri: 'https://www.rescuedogkitchen.com/wp-content/uploads/2021/11/IMG_3192.jpg',
              }}
            />
          </View>
        ...
        <View style={styles.view17}>
          <View style={styles.view18}>
            <Text style={styles.text10}>Add 1 to Cart R{price.toFixed(2)}</Text>
          </View>
        </View>
      </View>
    );
...
const styles = StyleSheet.create({
  ...
  view4: {backgroundColor: 'white', marginBottom: 5},
  view5: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  text9: {fontWeight: 'bold', fontSize: 20, color: colors.grey1},
  view16: {
    width: 30,
    height: 30,
    borderRadius: 15,
